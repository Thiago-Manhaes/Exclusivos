			...
			do case
				...
				case upper(xmetodo) == 'USR_INIT' 
					...
					*Inicio Inclusao Campos Novos de Produtos no Cursor Pai -- v_faturamento_06 
					...
					oCur.addbufferfield("STATUS_NFE", "C(25)",.T., "STATUS_NFE", "FATURAMENTO.STATUS_NFE")				
				    ...
				    *adicao da coluna na grid de materiais 
					WITH THISFORMSET.lx_form1.lx_paGEFRAME1.page1.lx_GRID_FILHA1 			
						.addColumn(3)
						.Columns(33).name="col_filial_estoque"
						.col_filial_estoque.Header1.Caption="Filial Estoque"
						.col_filial_estoque.ControlSource='v_faturamento_00.filial_estoque'
						...
						.col_filial_estoque.header1.Alignment=THISFORMSET.lx_form1.lx_paGEFRAME1.page1.lx_GRID_FILHA1.coL_TX_EMISSAO.Alignment  
...
DEFINE CLASS tv_filial_estoque AS lx_textbox_valida
	...
	Visible = .T.
	Enabled = .T.
	ControlSource = "v_faturamento_00.filial_estoque"
	Format = "!"
