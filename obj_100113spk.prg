			...
			do case
				...
				case upper(xmetodo) == 'USR_INIT' 
					...
					*Inicio Inclusao Campos Novos de Produtos no Cursor Pai -- v_faturamento_06 
					sele v_faturamento_06   
					xalias_faturam=alias()

	  				oCur = getcursoradapter(xalias_faturam)
					oCur.addbufferfield("FILIAL_ESTOQUE", "C(25)",.T., "FILIAL_ESTOQUE", "W_FATURAMENTO_06.FILIAL_ESTOQUE")				
				    ...
				    *adicao da coluna na grid de materiais 
					WITH thisformset.lx_form1.lx_PAGEFRAME1.page1.lx_grid_filha1			
						.addColumn(1)
						.column1.Name="col_filial_estoque"
						.col_filial_estoque.Header1.Caption="Filial Estoque"
						.col_filial_estoque.ControlSource='v_faturamento_06.filial_estoque'
...
DEFINE CLASS tv_filial_estoque AS lx_textbox_valida
	...
	Visible = .T.
	Enabled = .T.
	ControlSource = "v_faturamento_06.filial_estoque"
	Format = "!"
