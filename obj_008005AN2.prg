		...
		*=messagebox( 'Metodo '+ UPPER(xmetodo) + ' Nome Objeto ' + upper(xnome_obj) )
			...
			do case
				...
				case upper(xmetodo) == 'USR_INIT' 
					...
					*Inicio Inclusao Campos Novos de Produtos no Cursor Pai -- V_LOJA_RESUMO_OPERACAO_01_OPERACOES_VENDA
*!*						sele V_MATERIAIS_02_COMPRAS
*!*						xalias_filha=alias()
*!*						
*!*						oCur = getcursoradapter(xalias_filha)
*!*						oCur.addbufferfield("COMPRAS_STATUS.DESC_STATUS_COMPRA", "C(25)",.T., "DESC_STATUS_COMPRA", "COMPRAS_STATUS.DESC_STATUS_COMPRA")				
*!*						oCur.confirmstructurechanges() 	
*!*						**-Fim Inclusao Campos Novos de Produtos no Cursor Pai
