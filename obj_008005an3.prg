			...
			Do case
				...
				** #GS02 - Desenvolvedor: Lucas Miranda - Solicitante: Maria Fernanda (Dep. Internacional) - 05/01/2016 - Criação das colunas Necessidade e Fabricante
				...
				case upper(xmetodo) == 'USR_INIT' 
					...
					** INCLUSAO DA COLUNA REF E STATUS ESTAMPA
					Sele v_materiais_02				
					xalias_pai=alias()

  					oCur = getcursoradapter(xalias_pai)
					oCur.addbufferfield("MATERIAIS_CORES.GS_STATUS_ESTAMPA", "C(20)",.T., "STATUS ESTAMPA", "MATERIAIS_CORES.GS_STATUS_ESTAMPA")			
					oCur.addbufferfield("MATERIAIS_CORES.REFER_FABRICANTE as REF_COR_FAB", "C(25)",.T., "REFERENCIA COR FABRICANTE", "MATERIAIS_CORES.REFER_FABRICANTE AS REF_COR_FAB")	
					oCur.confirmstructurechanges() 	
					** Fim
					...
					*** Fim #GS02
					...
					ThisFormSet.LX_FORM1.LX_PAGEFRAME1.Page2.LX_GRID_FILHA1.Col_tx_DESC_FASE_PRODUCAO.h_tx_DESC_FASE_PRODUCAO.Caption='Programação'
						...
						**** Inclusão da coluna gs_status_estampa e ref fabricante cor
						
						with  ThisFormSet.lx_form1.lx_pageframe1.page1.lX_GRID_FILHA1
										xcColumnCount = .columncount
										xcColumnCount = xcColumnCount + 1 
									.addcolumn(xcColumnCount)
									.columns[xcColumnCount].name = 'col_status_estampa'
									.col_status_estampa.width = 150
									.col_status_estampa.BackColor = ThisFormSet.LX_FORM1.LX_PAGEFRAME1.Page5.LX_GRID_FILHA1.Col_tx_DESC_MATERIAL.BackColor 
									.col_status_estampa.FontSize = ThisFormSet.LX_FORM1.LX_PAGEFRAME1.Page5.LX_GRID_FILHA1.Col_tx_DESC_MATERIAL.FontSize 
									.col_status_estampa.FontName = ThisFormSet.LX_FORM1.LX_PAGEFRAME1.Page5.LX_GRID_FILHA1.Col_tx_DESC_MATERIAL.FontName 
									.col_status_estampa.Header1.name='h_status_estampa'
									.col_status_estampa.h_status_estampa.caption = 'Status Aprovação'
									.col_status_estampa.h_status_estampa.alignment = 2
									.col_status_estampa.h_status_estampa.FONTSIZE = 8
									.col_status_estampa.h_status_estampa.FontName = "Tahoma"
									.col_status_estampa.refresh()
									.col_status_estampa.ControlSource="v_materiais_02.gs_status_estampa"
						endwith
						...
						with  ThisFormSet.lx_form1.lx_pageframe1.page1.lX_GRID_FILHA1
										...
										xcColumnCount = xcColumnCount + 1 
									.addcolumn(xcColumnCount)
									.columns[xcColumnCount].name = 'col_ref_cor_fabr'
									.col_ref_cor_fabr.width = 150
									.col_ref_cor_fabr.BackColor = ThisFormSet.LX_FORM1.LX_PAGEFRAME1.Page5.LX_GRID_FILHA1.Col_tx_DESC_MATERIAL.BackColor 
									.col_ref_cor_fabr.FontSize = ThisFormSet.LX_FORM1.LX_PAGEFRAME1.Page5.LX_GRID_FILHA1.Col_tx_DESC_MATERIAL.FontSize 
									.col_ref_cor_fabr.FontName = ThisFormSet.LX_FORM1.LX_PAGEFRAME1.Page5.LX_GRID_FILHA1.Col_tx_DESC_MATERIAL.FontName 
									.col_ref_cor_fabr.Header1.name='h_ref_cor_fabr'
									.col_ref_cor_fabr.h_ref_cor_fabr.caption = 'Referência Cor Fab.'
									.col_ref_cor_fabr.h_ref_cor_fabr.alignment = 2
									.col_ref_cor_fabr.h_ref_cor_fabr.FONTSIZE = 8
									.col_ref_cor_fabr.h_ref_cor_fabr.FontName = "Tahoma"
									.col_ref_cor_fabr.refresh()
									.col_ref_cor_fabr.ControlSource="v_materiais_02.REFER_FABRICANTE"
						endwith
						*** Fim
						Thisformset.L_limpa()
					if !f_vazio(xalias)	
