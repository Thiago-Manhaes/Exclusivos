								...
								if Thisformset.LX_FORM1.LX_PAGEFRAME1.page4.LX_PAGEFRAME1.ActivePage = 1 
									...
									**** Lucas Miranda - 16/03/2017 - Bloqueia Programação *****
										...
										Go Top 
											...
											If !F_Vazio(xMsgBloq)
												MESSAGEBOX('Existe(m) produto(s) na rota com o fornecedor bloqueado programação !!! '+CHR(13)+CHR(13)+"Referências\Cor: "+LEFT(xMsgBloq,LEN(xMsgBloq)-2),0+16,"Bloqueia Programação")
												Return .F.
											Endif
