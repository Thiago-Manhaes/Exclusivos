	...
	procedure metodo_usuario
		...
		*=messagebox( 'Metodo '+ UPPER(xmetodo) + ' Nome Objeto ' + upper(xnome_obj))
			...
			case upper(xmetodo) == 'USR_INIT'	
				...
				Thisformset.lx_FORM1.Lx_grid_filha1.Col_tx_TEXTO_TRADUZIDO.Tx_TEXTO_TRADUZIDO.Format = ""
				Thisformset.lx_FORM1.Lx_grid_filha1.Col_tx_TEXTO_TRADUZIDO.Tx_TEXTO_TRADUZIDO.InputMask=""
