* Criação *********************************************************************************************************** 
* PROGRAMADOR(A).:  Andre Maia                                                                                      *
* DATA...........:  22/07/2015                                                                                      *
* HORÁRIO........:  13;00                                                                                           *
********************************************************************************************************************* 
* CLIENTE..: Animale                                                                                                *
* OBJETIVO.: Criar botao para reprocessar o bordero																    *
********************************************************************************************************************* 
			...
			do case
				...
				case upper(xmetodo) == 'USR_INIT'
					...
					with thisformset.lx_form1.lx_pageframe1.page2
						.cnt_lanc_auxiliar.tx_obs.height = 100

						.addObject("bt_repr","bt_repr")
						.bt_repr.Left  = 5
						.bt_repr.Top = 370
						.bt_repr.visible=.T.
						.bt_repr.anchor = 260
...
DEFINE CLASS bt_repr AS botao
	...
	PROCEDURE click
		...
		IF thisformset.p_tool_status='P'
			IF !f_vazio(v_ctb_lancamento_01.lancamento) AND RECCOUNT('v_ctb_lancamento_01_item') = 0
				If !f_execute("EXECUTE LX_CTB_BORDERO_RECEBER_RETORNO ?v_ctb_lancamento_01.empresa, ?v_ctb_lancamento_01.lancamento")
					Return .F.
				ELSE
