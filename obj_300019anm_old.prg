...
IF xResp = 6
f_select("EXEC ANIMALE.DBO.LX_ANM_LUCATIVIDADE ?Data_Ini,?Data_Fim,?xFilial,'S'","xLucratividade")
ELSE
f_select("EXEC ANIMALE.DBO.LX_ANM_LUCATIVIDADE ?Data_Ini,?Data_Fim,?xFilial,'N'","xLucratividade")
ENDIF
