...
TEXT TO XSEL NOSHOW TEXTMERGE 
	...
	FROM 
		...
		where 
		Loja_venda.valor_cancelado=0
		AND Tipos_pgto.ANMTIPO_PGTO_CONSOLIDADO is not null 
		and Tipos_pgto.tipo_pgto not in ('V','X') 
		and Loja_venda.codigo_filial not in ('999998') 
	...
	LEFT JOIN 
		...
		WHERE ORIGEM = 'L'   
		and LOJAS_VAREJO.codigo_filial not in ('999998') 
		and Tipos_pgto.tipo_pgto not in ('V','X') 
...
COPY TO C:\TEMP\VENDASPGTO_FARM.XLS XLS
