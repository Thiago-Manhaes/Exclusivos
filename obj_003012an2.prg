	...
	procedure metodo_usuario
		...
		*=messagebox( 'Metodo '+ UPPER(xmetodo) + ' Nome Objeto ' + upper(xnome_obj) )
		...
		do case
			...
			case UPPER(xmetodo) == 'USR_INIT' and upper(xnome_obj) == 'VENDAS_005' and thisformset.p_tool_status = "L"
...
*!*						If V_VENDAS_00.TOT_QTDE_ENTREGAR = 0
*!*							
*!*							Sele V_VENDAS_00
				...
				xalias=alias()
					...
					ENDIF
						...
						WITH thisformset.lx_FORM1
							...
							*.lx_pageframe1.page1.cmb_filial_emissao.Enabled= .F.
							*.lx_pageframe1.page1.cmb_filial.Enabled= .F.
							...
							*.lx_PAGEFRAME1.page1.cmb_aprovacao.Value=1
							
							
						ENDWITH				
					
					
*!*						If Thisformset.pp_anm_libera_campo_filial = .t.
*!*							thisformset.lx_FORM1.lx_pageframe1.page1.cmb_filial_emissao.Enabled= .T.
*!*							thisformset.lx_FORM1.lx_pageframe1.page1.cmb_filial.Enabled= .T.
*!*						Else
*!*							thisformset.lx_FORM1.lx_pageframe1.page1.cmb_filial_emissao.Enabled= .F.
*!*							thisformset.lx_FORM1.lx_pageframe1.page1.cmb_filial.Enabled= .F.
*!*						Endif
