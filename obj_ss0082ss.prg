define class obj_entrada as custom
	procedure metodo_usuario
		...
		** 17/05/2017 - Bruno Silva (SS) - De / Para: Preenchimento automatico de caixa, estação, marca e colecao.
		...
		DO CASE
			...
			CASE UPPER(xmetodo) == 'USR_VALID' AND UPPER(ALLTRIM(xnome_obj)) = 'TV_PRODUTO' AND !F_VAZIO(THISFORM.TV_PRODUTO.VALUE) AND ALLTRIM(thisformset.p_tool_status) == 'I'
				...
				IF !f_select(lcSql, 'temp_ss_cur_produto')
					MESSAGEBOX("Não foi possivel buscar as informações do Produto.",0+16,"Atenção")
					RETURN .f.
				endif
