...
DEFINE CLASS imprime_varejo AS commandbutton
	...
	Height = 55
	Width = 175
	Caption = "Impressão Código de Barras"
	Name = "imprime_varejo"
	visible=.t.
	enabled=.t.
		...
		ELSE
			...
			*	replace qtde_etiquetas WITH 1
				...
				GATHER NAME obarras MEMO 
					...
					REPORT FORM wdir_exe+'REPORT\USER\U002016QR1 IMPRESSÃO DE ETIQUETA COD. BARRAS.frx' NOCONSOLE TO PRINTER 
		...
		ELSE
			...
			*	replace qtde_etiquetas WITH 1
				...
				GATHER NAME obarras MEMO 
					...
					xqtdeetiq=PADL(ALLTRIM(STR(ROUND((qtde_etiquetas/2),0))),4,'0')
					replace qtde_etiquetas WITH 2
					REPORT FORM wdir+'LINX\REPORT\USER\U002016QR1 IMPRESSÃO DE ETIQUETA TERMICA GENERICA VAREJO.FRX' NOCONSOLE TO PRINTER 
