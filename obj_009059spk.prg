	...
	*=messagebox( 'Metodo '+ UPPER(xmetodo) + ' Nome Objeto ' + upper(xnome_obj) )
	...
	Do Case
		...
		Case Upper(xmetodo) == 'USR_INIT'
			...
			*** WALLACE PACHECO - 19/09/2016 - PROJETO TI Nº 234035 ***
			** incluir o botão **
			...
			*** FIM - WALLACE PACHECO - 19/09/2016 - PROJETO TI Nº 234035  ***
			
			*** WALLACE PACHECO - 13/10/2016 - PROJETO TI Nº ***
			** incluir o botão **
			.addobject("CmdImportar2","GeraAcompFin")
			.CmdImportar2.Height = 27
			.CmdImportar2.Top = 22
			.CmdImportar2.Left = 180
			*** FIM - WALLACE PACHECO - 19/09/2016 - PROJETO TI Nº ***
...
*** WALLACE PACHECO - 19/09/2016 - PROJETO TI Nº ***
				...
				if RECCOUNT() > 0
					...
					*BROWSE normal
					...
					if !f_insert(xInsertAcompanhamento) && insere acompanhamento
						messagebox("Não foi possível inserir o acompanhamento",16,"Atenção!!!")			
					ENDIF
					...
					*BROWSE normal
					...
					if	(!EMPTY(xCur_titAcomp.lancamento)) &&** TRATA CASO ONDE ACOMPANHAMENTO FOI REALIZADO
						messagebox("Lançamento já cadastrado: "+allt(STR(xCur_titAcomp.LANCAMENTO,10))+" | Usuário: "+allt(xCur_titAcomp.usuario)+" | Ocorrência: "+allt(str(xCur_titAcomp.OCORRENCIA,10))+" | Data Acompanhamento: "+allt(ttoc(xCur_titAcomp.data_acompanhamento)),48,"Aviso Importante!!!" )
					endif
					...
					sele xCur_titAcomp2
					if	(!EMPTY(xCur_titAcomp2.lancamento)) &&** TRATA CASO ONDE LANÇAMENTO NÃO EXIGE FATURA
						messagebox("Lançamento: "+allt(STR(xCur_titAcomp2.LANCAMENTO,10))+" não pode ser acompanhado pois não possui fatura. Favor verificar ",48,"Erro Encontrado!!!" )
					endif
					...
					*Messagebox(acomp_ja_cadastrado,0,"Lançamento já Acompanhados!")
					*ENDIF 
					Messagebox("Processamento Concluído!!!",0,"Informação!!!")
