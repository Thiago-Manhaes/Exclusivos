	...
	PROCEDURE CLICK
		if this.parent.parent.p_tool_status $ 'I,A'
			...
			if len(xarquivo) > 0 and file(xarquivo)
				...
				cod_historico C(4), historico C(250), lmc_historico C(250), cod_filial C(6), rateio_centro_custo C(15), rateio_filial C(15), valor N(16,2), lancamento C(10))
...
*!*				endif
				...
				ENDIF
					...
					*BROWSE normal
					...
					SELECT lancamento, data_lancamento, lx_tipo_lancamento, id_imposto, id_sub_item_apuracao, cod_filial, valor, rateio_centro_custo, lmc_historico FROM xcur INTO CURSOR  xcuror_tela_relatorio
