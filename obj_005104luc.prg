	...
	procedure metodo_usuario
		...
		*!* Fim - Instancia um objeto da classe "Obj_Entrada_XML" #XML_2015
		...
		do case
			...
			**LIBERAR CAMPO PARA INCLUIR POR MATERIAL
		**	 thisformset.lx_FORM1.lx_pageframe1.page8.lx_GRID_Pedidos.Col_tx_MATERIAL.Enabled= .T.
			...
			*** FIMM - #XML *****
			...
			case UPPER(xmetodo) == 'USR_VALID'
				...
				**** Julio - Veficica junto ao parâmetro ANM_NATUREZAS_IMPORTACAO as naturezas Permitidas para entrada de importação. ****
				...
				If upper(xnome_obj)=='BOTAO_PEDIDO'
					Thisformset.lx_FORM1.lx_pageframe1.page8.lx_GRID_Pedidos.Col_tx_MATERIAL.Enabled= .T.
				ENDIF	
...
*** LUCAS MIRANDA REVISÃO 20/02/2015
				...
				xalias=alias()
					...
					*!* Chama a função disponível na classe criada para tratar xml *!* #XML_2015
					If TYPE("o_005104.pp_anm_obj_entrada_xml")<>'U' AND Thisformset.pp_anm_obj_entrada_xml
