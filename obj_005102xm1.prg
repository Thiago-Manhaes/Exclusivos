...
*!*																				
*!*															IF F_VAZIO(CurFilialOS.filial)
*!*																MESSAGEBOX("Existe Produto Sem Pedido")
*!*																RETURN .f.
*!*															Endif
...
*!*									          ELSE A.FILIAL_A_ENTREGAR END,A.FILIAL_A_ENTREGAR) AS FILIAL								

*!*												FROM (SELECT A.*, B.PRODUTO
*!*													  FROM COMPRAS A
*!*													  JOIN COMPRAS_PRODUTO B
*!*													  ON A.PEDIDO = B.PEDIDO) A
...
*!*												WHERE A.PEDIDO = '<<V_ENTRADAS_00_PROD1_ENT.PEDIDO>>'
*!*										 	
*!*										 	ENDTEXT
*!*											 	
...
*!*							Endif
*!*							
*!*							If ALLTRIM(v_entradas_00_prod1_ent.filial) <> ALLTRIM(CurFilialOS.Filial)
*!*								If xPerg = 0
*!*									xPerg = MESSAGEBOX("Deseja entrar com o Pedido na Revisão ?",4+16)
*!*								ENDIF
*!*							
