...
********************************************************************************************************************* 
* CLIENTE..: Animale                                                                                                *
* OBJETIVO.: Botão de agendamento para JOB						                    *
********************************************************************************************************************* 
...
********************************************************************************************************************* 
*- Programa Base de Criaçãoo de Objeto de Entrada                                                                    *
********************************************************************************************************************* 
...
DEFINE CLASS bt_agenda_job AS botao
	...
	LOCAL resposta as Date, dtIni as Date, dtFim as Date , a as Integer, xCusto as string, xComando as String, Retorno as String
		...
		*MESSAGEBOX(xComando)
		...
		Retorno = INPUTBOX("Digite a data para agendamento","Informação",ddate,0,'Timed Out','Cancelado')
		IF Retorno <> "Cancelado"
			...
			IF (a < 0)
				MESSAGEBOX("Data menor que o dia corretente, não agendando!",16,"Atenção")
			ELSE
				xComando = ""	
				...
				MESSAGEBOX("Agendamento realizado!",64,"Informação")
			ENDIF
		ENDIF 	
