					...
					xalias=alias()
								...
								LOCATE FOR tipo = v_produtos_ficha_01.tipo
									...
									If !(Cur_ProgMost_S_OP.Qtde_prog_s_OP > 0 AND v_produtos_00.MOST_FINALIZADO= 'SIM')
										...
										If thisformset.pp_ANM_ALT_CONS_PAN= .F. AND (v_produtos_ficha_01.tipo $ thisformset.pp_ANM_TIPO_MATERIAL_FT_PA or  CurMaterialTipo.indica_tecido= .T. ) AND v_produtos_00.TEC_FINALIZADO= 'SIM'
											Return .F.
										Endif
