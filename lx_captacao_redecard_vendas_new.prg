...
PROCEDURE	LX_CAPTACAO_REDECARD_VENDAS_NEW
			...
			aStatus(44,1)	= '108' 
			aStatus(44,2)	= 'AUT CARTÃO DIFERENTE      '
			aStatus(45,1)	= '109' 
			...
			aStatus(49,1)	= '114' 
			aStatus(49,2)	= 'CARTÃO N CRED/DINERS      '
			aStatus(50,1)	= '115' 
			aStatus(50,2)	= 'FALTA 2A VIA PROCESS      '
			aStatus(51,1)	= '117' 
			aStatus(51,2)	= 'CV / NSU IRREGULAR        '
			aStatus(52,1)	= '125' 
			aStatus(52,2)	= 'CARTÃO N CRED/DINERS      '
			aStatus(53,1)	= '137' 
			...
			aStatus(56,1)	= '143' 
			aStatus(56,2)	= 'MQ INVA/NÃO TR VISTA      '
			aStatus(57,1)	= '144' 
			...
			aStatus(60,1)	= '148' 
			aStatus(60,2)	= 'ESTAB. NÃO AUTORIZADO     '
			aStatus(61,1)	= '149' 
			aStatus(61,2)	= 'DESCUMPRIM DE PROCED      '
			aStatus(62,1)	= '194' 
			aStatus(62,2)	= 'CV / NSU SEM AUTORIZAÇÃO  '
			aStatus(63,1)	= '198' 
