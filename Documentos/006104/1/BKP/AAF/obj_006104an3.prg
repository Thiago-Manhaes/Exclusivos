				...
				case upper(xmetodo) == 'USR_VALID' 
					...
					xalias=alias()
						...
						IF UPPER(xnome_obj)== 'LX_TEXTBOX_VALIDA1'
							...
							F_SELECT("SELECT FORNECEDOR FROM COMPRAS WHERE PEDIDO = ?V_ESTOQUE_SAI_MAT_00_OC.ORDEM_PRODUCAO","xFornPedido")	
							...
							ELSE
								...
								IF xFornPedido.FORNECEDOR <> ALLTRIM(V_ESTOQUE_SAI_MAT_00.NOME_CLIFOR)								
