...
*!*						*-Fim Inclusao Campos Novos de Produtos no Cursor Pai 
					...
					*** lucas *** 16/05/2016
						...
						sele V_LOJA_RESUMO_PRODUTO_00
*** #2 - LENTIDÃO AO CONSULTAR - 02/06/2016 - LUCAS MIRANDA	, FOI INSERIDA NA PRÓPRIA TELA NA VIEW V_LOJAS_RESUMO_PRODUTO_00						
*!*				  				oCur = getcursoradapter(xalias)
*!*								oCur.addbufferfield("LOJA_RESUMO_PRODUTO.DESC_PRODUTO_SEGMENTO", "C(25)",.F., "DESC_PRODUTO_SEGMENTO", "LOJA_RESUMO_PRODUTO.DESC_PRODUTO_SEGMENTO")
*!*								oCur.addbufferfield("LOJA_RESUMO_PRODUTO.DESC_CATEGORIA", "C(25)",.F., "DESC_CATEGORIA", "LOJA_RESUMO_PRODUTO.DESC_CATEGORIA")
*!*								oCur.addbufferfield("LOJA_RESUMO_PRODUTO.DESC_SUBCATEGORIA", "C(25)",.F., "DESC_SUBCATEGORIA", "LOJA_RESUMO_PRODUTO.DESC_SUBCATEGORIA")	
*!*								oCur.addbufferfield("LOJA_RESUMO_PRODUTO.DESC_PRODUTO_SOLUCAO", "C(25)",.F., "DESC_PRODUTO_SOLUCAO", "LOJA_RESUMO_PRODUTO.DESC_PRODUTO_SOLUCAO")			
*!*								oCur.confirmstructurechanges() 
*** #2 - LENTIDÃO AO CONSULTAR - 02/06/2016 - LUCAS MIRANDA	, FOI INSERIDA NA PRÓPRIA TELA NA VIEW V_LOJAS_RESUMO_PRODUTO_00								
								*** criação das colunas ***
