...
*!*						If f_vazio(curpropproducaoordemservico.valor_propriedade)
*!*							MESSAGEBOX("Filial a Entregar Não foi Informada !!!")
*!*							Return .F.
*!*						Endif
*!*						
*!*						If !f_vazio(curpropproducaoordemservico.valor_propriedade)	
*!*							xFilialEntregar=curpropproducaoordemservico.valor_propriedade
*!*							f_select("select MATRIZ from Filiais Where Filial = ?xFilialEntregar","curFilMatCont")
*!*							If curFilMatCont.matriz <> 'FARM MATRIZ'
*!*								MESSAGEBOX("Matriz Contábil da Filial a Entregar não é Farm Matriz não foi possível enviar para Consumo")
*!*								Return .F.
*!*							ELSE
