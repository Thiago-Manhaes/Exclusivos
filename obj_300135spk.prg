...
DEFINE CLASS bt_copia_dados AS botao
	...
	Width = 260
	*FontBold = .T.
	Caption = "Copiar a chave da NF-e para a área de transferência"
	TabIndex = 48
	Name = "bt_copia_dados"
	Visible = .T.
	...
	_cliptext = thisformset.lx_form1.lx_pageframe.page1.lx_grid_status_documento.COL_TX_CHAVE_NFE.TX_CHAVE_NFE.Value
