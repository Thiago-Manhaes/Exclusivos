	...
	procedure metodo_usuario
		...
		*=messagebox( 'Metodo '+ UPPER(xmetodo) + ' Nome Objeto ' + upper(xnome_obj) )
		...
		do case
				...
				** #GS01 - Lucas Miranda - 04/01/2017 - Bloqueia salvar se o campo responsável estiver em branco.
				...
				case UPPER(xmetodo) == 'USR_SAVE_BEFORE'  
					...
					**#GS01
					if f_vazio(LTRIM(RTRIM(v_estoque_sai_mat_00.responsavel)))
						messagebox("O Campo Responsável não pode ficar vazio !",0+16)
						retu .f.
					ENDIF
					**#GS01
					...
					** #2 - LUCAS MIRANDA - 24/10/2016 - TRANSFERENCIA DE MATERIAL RECICLA
					...
					LOCATE FOR propriedade = '00441'
						if f_vazio(curpropestoquesaimat.valor_propriedade)
							MESSAGEBOX("Favor preencher o tipo de Transferência !",0+16,"Tipo de Transferência")
							Return .F.
						endif	
