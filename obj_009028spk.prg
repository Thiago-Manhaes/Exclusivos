		...
		do case
			...
			case UPPER(xmetodo) == 'USR_SEARCH_AFTER' 
				...
				if thisformset.lx_FORM1.lx_pageframe1.page2.ck_processa_solicitacao_verba.value
					...
					xFiltroSolicitacao=(strtran(strtran(strtran(thisformset.p_clausula_where,"W_CTB_A_PAGAR_PARCELA","WANM_CTB_SOLICITACAO_VERBA_A_PAGAR")," E "," AND ")," CONTENDO "," LIKE "))
					text to xselSolicitacao noshow textmerge	
						select * from wanm_ctb_solicitacao_verba_a_pagar
					...
					scan	
						...
						scatter to xmemvar	
						sele v_ctb_a_pagar_fatura_01_parcela						
						appe blank	
						gather from xmemvar	
						sele curSVM	
					endscan					
